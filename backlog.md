...
- Current increment (2026-09-17): extend the existing distribution workflow report with verified portable-payload and installer byte totals, separating the application executable from declared resources without changing the package contract.
- Lease: root — `scripts/distribution.py`, `scripts/tests/test_distribution.py`, `docs/manual/distribution.md`, `docs/VERIFICATION.md`, `backlog.md`.
