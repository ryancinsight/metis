...
- Baseline: RITK `4a9f6eb1` ([PR 236](https://github.com/ryancinsight/ritk/pull/236)) verifies selected-study loading, restore/rejection and real native capture; [manual](docs/manual/applications.md#dicom-viewer-migration-baseline). This is egui prerequisite evidence, not Métis execution.
