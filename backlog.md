...
- Status: in-progress; priority: P1; owner: Metis Windows host + Moirai; integrator: root; last-update: 2026-09-14; branch: `docs/metis-visible-host-evidence-20260914`; regions: `crates/metis-platform/src/display_scale.rs`, `crates/metis-platform/src/lib.rs`, `crates/metis-ui-lang/src/layout.rs`, `crates/metis-frontend/src/app.rs`, `crates/metis-frontend/src/presentation.rs`, `crates/metis-app/src/frontend/native.rs`, `examples/presentation`, `tests`, `docs/manual/native.md`, `docs/VERIFICATION.md`; ADR: [0032](docs/adr/0032-display-scale.md); dependencies: METIS-AUTHORITY-001, METIS-COMMANDS-001; risk: trust boundary
...
- Status: in-progress; priority: P1; owner: Metis measurement; integrator: root; last-update: 2026-09-14; branch: `docs/metis-current-dicom-evidence`; regions: `docs/manual/README.md`, `docs/manual/applications.md`, `docs/VERIFICATION.md`, `backlog.md`; dependencies: METIS-BROWSER-001, METIS-DESKTOP-001, METIS-INPUT-001; risk: invalid comparative claims
...
- Status: in-progress; priority: P3; owner: Metis integration; integrator: root; last-update: 2026-09-13; branch: `refactor/conformance-structure-2026-09-13`; regions: `crates/metis-backend/src`, `crates/metis-core/src/protocol`, `crates/metis-python/src/native`, `crates/metis-ui-lang/src/layout.rs`, `crates/metis-web/src`, `tests/safety_interlock_tests.rs`; risk: structural conformance debt
