...
- Status: in-progress; priority: P1; owner: Metis frontend/host; integrator: root; last-update: 2026-09-13; branch: `feat/browser-cross-engine-001`; regions: `scripts/browser_runtime.py`, `scripts/tests/test_browser_runtime.py`, `docs/manual/browser.md`, `docs/VERIFICATION.md`, `backlog.md`; dependencies: METIS-STATE-001, METIS-ASYNC-001, METIS-AUTHORITY-001; risk: browser/native trust boundary
...
- Status: in-progress; priority: P1; owner: Metis presentation; integrator: root; last-update: 2026-09-13; branch: `test/metis-layout-scale-visual-001`; regions: `docs/manual/browser.md`, `docs/VERIFICATION.md`, `backlog.md`; dependencies: METIS-STATE-001; risk: silent scale mismatch
- lease: root `docs/manual/browser.md`, `docs/VERIFICATION.md`, `backlog.md` (2026-09-13T13:00:00-04:00)
