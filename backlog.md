...
- Residuals: configured live WebDriver success/rejection/stale-generation captures and provider-private listener/allocation counts remain open. The in-app browser now has live normal and delayed HTTP traces; the exact full gate reports matching pixels and semantics with the reviewed capture baseline refreshed, and the locked WASM library build passes.
