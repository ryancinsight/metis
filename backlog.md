...
- Status: in-progress; priority: P1; owner: Metis documentation; integrator: root; last-update: 2026-09-18; dependencies: METIS-GAPS-001, METIS-GAPS-002.
- Outcome: Add a source-pinned Svelte/SvelteKit comparison to ADR 0003 and the user-manual index, then turn its findings into the next implementation order.
...
- lease: root docs/adr/0003-framework-conformance.md docs/manual/README.md README.md backlog.md 2026-09-18T00:00:00-04:00
...
- Delivery increment (2026-09-18, RITK PR #480 merge `0fd885adc6124468aa745a2f548dd685b74f0774`): the eframe compatibility package now has a shell-free `orthogonal-surface` capture over the same 94-file MRI study. Its semantic surfaces are exactly `axial`, `coronal`, `sagittal`, with three equal lifecycle runs and an identical 1600 × 1000 PNG digest; the [provenance record](https://github.com/ryancinsight/ritk/blob/main/docs/manual/images/dicom-eframe-orthogonal-surface-resource.json) records mean peak private bytes `427,410,773 ± 26,382,414` and duration `2,991 ± 1,545 ms`. This closes the eframe semantic fixture prerequisite; the host extent, process boundary, GPUI/Tauri fixtures and ranking residuals remain open.
