...
- Status: in-progress; priority: P1; owner: Metis frontend/host; integrator: root; last-update: 2026-09-16; regions: scripts/browser_drop.py, scripts/browser_canvas_capture.py, scripts/tests/test_browser_drop.py, docs/manual/browser.md, docs/VERIFICATION.md, backlog.md; dependencies: METIS-STATE-001, METIS-ASYNC-001, METIS-AUTHORITY-001; risk: browser/native trust boundary
