...
- Active increment (2026-09-13): root owns bounded software polyline strokes in `metis-platform` and the matching `DisplayCommand`; width, cap, and join semantics are documented, tested, and demonstrated through the existing image capture. Lease: root `crates/metis-platform/src/rasterizer.rs`, `crates/metis-ui-lang/src/layout.rs`, `examples/image.rs`, docs 2026-09-13.
