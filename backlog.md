...
- Residuals: native image decode and clinical orientation metadata, selected fallback-face identity, cross-engine/native font metrics, video playback/native media providers, GPU vectors, and runtime shell rendering on a Windows install remain open under V06; browser local-mark decode, font resource loading, audio playback, media error/teardown, SVG admission, ICO packaging and format-neutral pixel-grid orientation contracts are closed.
...
- Completed increment (2026-09-18): Moirai PR #400 (`7aa9d4e2`) adds explicit WebGPU provider recreation; `CanvasSurface::recreate` keeps the canvas and input listener guards, replaces handles only after successful setup and rejects raster recovery without fallback. Locked `metis-web` WASM check, strict Clippy, native nextest (49/49), rustdoc and lock integrity pass; real device-loss and recovered-pixel browser evidence remain open.
...
- Residuals: real device-loss/recovered-pixel browser evidence, browser vector parity, a measured GPU profile and GPU resource evidence remain open.
...
- Current replay reconciliation (2026-09-19): the standalone-lock real-MRI replay binds RITK lock PR #512 merge `836b4b3e63b299b40433ab5deef35b7fdddc9ed6`, Metis `a6af382ebf009806c920c07ae4031a98ea4a678a`, Moirai `b179b89fd2521034d2fc9c97663649811982e9fa` and Cargo.lock SHA-256 `2e7815d44374804038cc7236c2fda4cd6539e7f5be46393ba73dbe981422a1c1`; the 94-file, 49,807,236-byte study produced the byte-identical 1280 × 800 frame with 411,589 non-black pixels, executable SHA-256 `1c1fa032cde5381d80a3d4baa25f6f35ff5d4cba48f08f925c600c34de4f14a3`, and invalid-study exit 1. The exact provenance is recorded in [RITK's replay record](../ritk/docs/manual/images/dicom-metis-real-mri.json). This closes the current lock/evidence prerequisite; matched GPUI/Tauri fixtures, allocator/compositor measurements and controlled-host ranking remain open.
...
- Current replay reconciliation (2026-09-19): the standalone lock binds RITK lock PR #512 merge `836b4b3e63b299b40433ab5deef35b7fdddc9ed6`, Metis `a6af382ebf009806c920c07ae4031a98ea4a678a`, Moirai `b179b89fd2521034d2fc9c97663649811982e9fa` and Cargo.lock SHA-256 `2e7815d44374804038cc7236c2fda4cd6539e7f5be46393ba73dbe981422a1c1`. The 94-file, 49,807,236-byte replay remains the 1280 × 800, 411,589 non-black-pixel MRI frame with capture SHA-256 `259dd79103482756c4e688621bebafc841cc40f1df10ff2bbd7f9d04b7b4d401` and executable SHA-256 `1c1fa032cde5381d80a3d4baa25f6f35ff5d4cba48f08f925c600c34de4f14a3`; the invalid-study probe exits 1. [RITK's replay provenance](../ritk/docs/manual/images/dicom-metis-real-mri.json) is authoritative; matched GPUI/Tauri, WASM used-memory/allocation, compositor/native latency and controlled-host ranking residuals remain open.
- Current resource increment (2026-09-19): `scripts/resource.py` ran three bounded lifecycle samples against the standalone-lock RITK/Métis executable and 94-file public MRI-DIR study. Peak private bytes averaged 816,218,112 ± 798,240; peak working set averaged 372,658,176 ± 20,183,778; lifecycle duration averaged 2,189 ± 349 ms; all exits and capture hashes passed. The record binds Metis `a6af382ebf009806c920c07ae4031a98ea4a678a`, RITK `836b4b3e63b299b40433ab5deef35b7fdddc9ed6`, Moirai `b179b89fd2521034d2fc9c97663649811982e9fa` and command fingerprint `51d7d39fc8da3d5af9676e9cc2383168c60d24fe8d08e893202e1d1c67005652`; it is a current fixture measurement rather than a framework ranking. Matched GPUI/Tauri/egui, WASM allocator, compositor and ranking residuals remain open.
- Current matched eframe increment (2026-09-19, source RITK `3a76cbe4ac388267fd4016ec0fc21106ec569964`): the shell-free orthogonal fixture reran the same 94-file study at the same 1280×800 physical extent and repeated source SHA `2e47199cca0851f5ca2e3ce7b613cf70b096c3528bfc1eb705f64ced75485ba9`. Mean peak private bytes were 416,239,616 ± 29,801,008 and lifecycle duration 2,976 ± 1,949 ms; the first cold launch accounts for the uncertainty. Explicit semantic matching reports eframe minus Métis deltas of −399,978,496 ± 29,811,697 private bytes, −12,997,973 ± 21,021,301 working-set bytes and +787 ± 1,980 ms duration; no framework ranking is claimed.
...
- Current lock correction (2026-09-19): the authoritative standalone consumer replay is RITK lock PR #512 merge `836b4b3e63b299b40433ab5deef35b7fdddc9ed6`, with Metis `a6af382ebf009806c920c07ae4031a98ea4a678a`, Moirai `b179b89fd2521034d2fc9c97663649811982e9fa` and Cargo.lock SHA-256 `2e7815d44374804038cc7236c2fda4cd6539e7f5be46393ba73dbe981422a1c1`. The locked native replay remains 450/450 with the 94-file, 49,807,236-byte study, byte-identical 1280 × 800 frame (`259dd791...`, 411,589 non-black pixels) and invalid-study exit 1; the older hashes above are historical evidence, not the current comparison basis. The next conformance slices are OS capability enforcement, native accessibility/IME evidence, matched GPUI/Tauri fixtures, and explicit WebGPU recovery; Safari selected-file authorization remains an external host blocker.
