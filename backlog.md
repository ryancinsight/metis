...
- Status: in-progress; priority: P1; owner: Metis frontend/host; integrator: root; last-update: 2026-09-14; branch: `fix/metis-browser-blob-csp`; regions: backlog.md, crates/metis-core/src/content_security_policy.txt, examples/browser/index.html, examples/browser/http-health.html, examples/browser/gallery.html, crates/metis-core/tests/host.rs, docs/adr/0011-host-authority-policy.md, README.md, docs/manual/browser.md; dependencies: METIS-STATE-001, METIS-ASYNC-001, METIS-AUTHORITY-001; risk: browser/native trust boundary
...
- Residuals: WebKit file-backed reads, physical file-manager input, provider-private listener/resource counts, TLS, accessibility/IME, post-drop allocation and native desktop evidence remain open; DICOM parsing and viewer semantics stay with RITK under [RITK-SNAP-DICOM-SUBSTRATE-001](../ritk/backlog.md#RITK-SNAP-DICOM-SUBSTRATE-001).
