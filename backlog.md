...
- Residuals: device-loss/recreate handling, GPU acceleration, browser vector parity and a measured profile remain open.
...
- Status: in-progress; priority: P3; owner: Metis integration; integrator: root; last-update: 2026-09-16; branch: `docs/metis-residual-reconcile`; regions: `backlog.md`; risk: structural conformance debt
