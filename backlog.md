...
- Current increment: `metis-platform::native::WebViewSurface` consumes the merged provider through a safe adapter. It sizes the controller, maps validated visibility, forwards combined window/WebView events and preserves bounded navigation and JSON messaging. Metis uses git-plus-version Moirai requirements; the current standalone Cargo.lock records provider revision `8a8daa60cca5484822c772bc6b574acaa8f133ad`, descended from the WebView2 provider revision `c7b49a7623aed533f377aec77f656a16d2b9d68b` that generated the historical capture. Configuration and ignored installed-runtime adapter tests pass on WebView2 `152.0.4191.66`, covering packaged navigation, the ready bridge message, external-navigation denial and close. The visible bundle journey is captured in [`docs/manual/images/native-captures.json`](docs/manual/images/native-captures.json).
...
- Residuals: native formats beyond the admitted static PNG subset and clinical orientation metadata, selected fallback-face identity, cross-engine/native font metrics, video playback/native media providers, GPU vectors, and runtime shell rendering on a Windows install remain open under V06; browser local-mark decode, font resource loading, audio playback, media error/teardown, SVG admission, ICO packaging and format-neutral pixel-grid orientation contracts are closed.
...
- Lease: root docs/manual/applications.md, docs/VERIFICATION.md, docs/adr/0003-framework-conformance.md, gap_audit.md; started 2026-09-20.
...
- Current replay reconciliation (2026-09-19): the standalone lock binds RITK lock PR #515 merge `9881b9c4ac9fdccbc241c94fe1903f30d4f20e95`, with source `f1a556786e849696caa73d8c341adf309e87d163`, Metis `8d4ab58e8731c51547bbca3ec87100facb698322`, Moirai `f038622d24907884ce5f386da4e04d05bdb60d62` and Cargo.lock SHA-256 `2825653169ee324f9421122416da1e65a279e8657841c7fce9347386f6b58745`. The 94-file, 49,807,236-byte replay remains the 1280 × 800, 411,589 non-black-pixel MRI frame with capture SHA-256 `259dd79103482756c4e688621bebafc841cc40f1df10ff2bbd7f9d04b7b4d401` and executable SHA-256 `1c1fa032cde5381d80a3d4baa25f6f35ff5d4cba48f08f925c600c34de4f14a3`; the invalid-study probe exits 1. RITK replay provenance at ../ritk/docs/manual/images/dicom-metis-real-mri.json is authoritative; matched GPUI/Tauri, WASM used-memory/allocation, compositor/native latency and controlled-host ranking residuals remain open.
...
- Status: in-progress; priority: P1; owner: Metis measurement; integrator: root; last-update: 2026-09-19; dependencies: METIS-BROWSER-001, METIS-DESKTOP-001, METIS-INPUT-001, Moirai PR #360; risk: invalid comparative claims
...
- Current replay reconciliation (2026-09-20): the standalone lock binds RITK geometry PR #518 merge `694904718d7ec922883ab2a6b572e9aa29edab99`, with Metis `165c4ec923e76ea7bc32b6b4fb99b4338166b3`, Moirai `2a54e010532f76c88027fec8a468620c92fe66b3` and Cargo.lock SHA-256 `4f4b96958a0545203775e21b3bd1152a864bd6b77847d2b638213d6b420b1084`. The 94-file, 49,807,236-byte replay remains the 1280 × 800, 411,589 non-black-pixel MRI frame with capture SHA-256 `259dd79103482756c4e688621bebafc841cc40f1df10ff2bbd7f9d04b7b4d401` and executable SHA-256 `b260611286c309a21a3132c0fbd20f855768f4cfe326e0cb99ab5820b1212b95`; the invalid-study probe exits 1. RITK replay provenance at ../ritk/docs/manual/images/dicom-metis-real-mri.json is authoritative; matched GPUI/Tauri, WASM used-memory/allocation, compositor/native latency and controlled-host ranking residuals remain open.
...
- Current geometry resource increment (2026-09-20; source RITK `b432ae69db2a0578d8f1eb176ae6fdb9233231a`, delivered by PR #518 merge `694904718d7ec922883ab2a6b572e9aa29edab99`; Metis `165c4ec923e76ea7bc32b6b4fb99b4338166b3`; Moirai `2a54e010532f76c88027fec8a468620c92fe66b3`; command SHA-256 `0c4212a829303fb78bf224892dd8889fce2675a57aea744ea4004ef8d6559be2`): `scripts/resource.py` ran three bounded lifecycle samples at 25 ms sampling with `--capture-application --capture`. All exits were 0 and the 1280 × 800, 411,589 non-black-pixel capture repeated SHA-256 `259dd79103482756c4e688621bebafc841cc40f1df10ff2bbd7f9d04b7b4d401`. Peak private bytes averaged 816,635,904 ± 1,193,823; peak working set averaged 390,056,619 ± 22,024,617; lifecycle duration averaged 2,014 ± 25 ms; peak handles were 414 and startup observation averaged 3 ± 1 ms. The updated [MRI resource provenance](docs/manual/images/dicom-metis-real-mri-resource.json) is the current fixture record; no framework ranking is claimed and matched GPUI/Tauri/egui, WASM allocator, compositor and ranking residuals remain open.
...
- Status: in-progress; priority: P3; owner: Metis integration; integrator: root; last-update: 2026-09-19; risk: structural conformance debt
...
- Current lock correction (2026-09-20): the authoritative standalone consumer replay is RITK geometry PR #518 merge `694904718d7ec922883ab2a6b572e9aa29edab99`, with Metis `165c4ec923e76ea7bc32b6b4fb99b4338166b3`, Moirai `2a54e010532f76c88027fec8a468620c92fe66b3` and Cargo.lock SHA-256 `4f4b96958a0545203775e21b3bd1152a864bd6b77847d2b638213d6b420b1084`. The locked native replay reports 454/454 focused tests with the 94-file, 49,807,236-byte study, byte-identical 1280 × 800 frame (`259dd791...`, 411,589 non-black pixels) and invalid-study exit 1; the older hashes above are historical evidence, not the current comparison basis. The next conformance slices are OS capability enforcement, native accessibility/IME evidence, matched GPUI/Tauri fixtures, and explicit WebGPU recovery; Safari selected-file authorization remains an external host blocker.
