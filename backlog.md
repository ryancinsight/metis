...
- Status: in-progress; priority: P1; owner: Metis Windows host + Moirai; integrator: root; last-update: 2026-09-13; branch: `feat/native-dpi-scale-001`; regions: `crates/metis-platform/src/display_scale.rs`, `crates/metis-platform/src/lib.rs`, `crates/metis-ui-lang/src/layout.rs`, `crates/metis-frontend/src/app.rs`, `crates/metis-frontend/src/presentation.rs`, `crates/metis-app/src/frontend/native.rs`, `examples/presentation`, `tests`, `docs/manual/native.md`, `docs/VERIFICATION.md`; ADR: [0032](docs/adr/0032-display-scale.md); dependencies: METIS-AUTHORITY-001, METIS-COMMANDS-001; risk: trust boundary
