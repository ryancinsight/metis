...
- Status: in-progress; priority: P1; owner: Metis frontend/host; integrator: root; last-update: 2026-09-16; regions: scripts/browser_drop.py, scripts/browser_canvas_capture.py, scripts/browser_gallery.py, scripts/tests/test_browser_drop.py, docs/manual/browser.md, docs/VERIFICATION.md, backlog.md; dependencies: METIS-STATE-001, METIS-ASYNC-001, METIS-AUTHORITY-001; risk: browser/native trust boundary
...
- Gallery runner correction (2026-09-16): the split slice-control orchestrator imports and exercises its shared math, input-settling and bounded-arrow helpers; a deterministic regression covers exact restoration, batched navigation and teardown. Its contract is consumer-generic, with DICOM selection and viewer semantics remaining in RITK.
