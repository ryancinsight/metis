...
- Browser runtime Edge increment claim: branch `feat/browser-edge-runner-001`; regions: `scripts/browser_trace.py`, `scripts/browser_runtime.py`, `scripts/browser_canvas.py`, `scripts/tests/test_browser_runtime.py`, `docs/manual/browser.md`, `backlog.md`; integrator: root.
