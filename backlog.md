...
- Status: in-progress; priority: P1; owner: Metis frontend/host; integrator: root; last-update: 2026-09-15; branch: `build/metis-moirai-size-lock`; regions: Cargo.lock, README.md, scripts/browser_canvas.py, scripts/browser_runtime.py, scripts/browser_drop.py, scripts/tests/test_browser_runtime.py, docs/manual/browser.md, backlog.md; dependencies: METIS-STATE-001, METIS-ASYNC-001, METIS-AUTHORITY-001; risk: browser/native trust boundary
