...
- Status: in-progress; priority: P3; owner: Metis integration; integrator: root; last-update: 2026-09-16; branch: `docs/metis-conformance-reconcile`; regions: `README.md`, `gap_audit.md`, `docs/VERIFICATION.md`, `docs/adr/0003-framework-conformance.md`, `docs/manual/browser.md`, `docs/manual/native.md`, `docs/manual/testing.md`, `backlog.md`; risk: structural conformance debt
