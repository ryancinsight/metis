...
- Delivery increment (2026-09-13): the workbench runner now records bounded repeated stop/remount cycles under `metrics.lifecycle_cycles`, with value-semantic listener, generation and mounted-control assertions; the dependency-free browser module passes 26/26. A live multi-cycle engine trace is still required before growth is used as comparative evidence.
