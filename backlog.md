...
- Status: in-progress; priority: P1; owner: Metis Windows host + Moirai; integrator: root; last-update: 2026-09-17; branch: `feat/metis-webview2-permission-event`; regions: `crates/metis-platform/src/native/mod.rs`, `crates/metis-platform/src/native/webview.rs`, `crates/metis-app/src/frontend/webview.rs`, `crates/metis-core/src/error.rs`, `Cargo.lock`, `README.md`, `docs/manual/native.md`, `docs/VERIFICATION.md`, `docs/adr/0015-native-window-provider.md`, `backlog.md`; ADR: [0032](docs/adr/0032-display-scale.md); dependencies: METIS-AUTHORITY-001, METIS-COMMANDS-001; risk: trust boundary
...
- lease: root `crates/metis-platform/src/native/mod.rs`, `crates/metis-platform/src/native/webview.rs`, `crates/metis-app/src/frontend/webview.rs`, `crates/metis-core/src/error.rs`, `Cargo.lock`, `README.md`, `docs/manual/native.md`, `docs/VERIFICATION.md`, `docs/adr/0015-native-window-provider.md`, `backlog.md` 2026-09-17T22:10:00Z
