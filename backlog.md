...
- Delivery increment (2026-09-13): `scripts/resource.py --capture` now binds each sampled process run to the regular image or artifact it emitted, recording only byte count, SHA-256 and repeated-digest identity. Missing, redirected and multiply linked artifacts fail the run; 136 script tests and the full Metis gate pass. The current RITK `7e5cbfe4ae554c2431879fa5b4f36b66735cbefc` public 94-file MRI-DIR T2 workflow through Metis `74788b5508f3c9e29e80b464702f9c648922004f` produced three successful, byte-identical 1280 × 800 captures (`259dd79103482756c4e688621bebafc841cc40f1df10ff2bbd7f9d04b7b4d401`); process-tree means and uncertainty are in [`dicom-metis-real-mri-resource.json`](docs/manual/images/dicom-metis-real-mri-resource.json).
