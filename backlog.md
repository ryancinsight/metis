...
- Current increment (2026-09-17): the standalone browser runner will measure Navigation Timing milestones, a caller-selected readiness element and the following animation frame across bounded reload samples; it reports browser page timing only.
- Lease: root — `scripts/browser_startup_latency.py`, `scripts/tests/test_browser_startup_latency.py`, `docs/manual/testing.md`, `docs/VERIFICATION.md`.
