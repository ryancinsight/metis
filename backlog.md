...
- Status: in-progress; priority: P1; owner: Metis protocol/browser; integrator: root; last-update: 2026-09-16; branch: `fix/metis-fragment-dynamic-port`; regions: `.github/workflows/ci.yml`, `scripts/browser_static_server.py`, `scripts/browser_fragment.py`, `scripts/browser_runtime.py`, `scripts/tests/test_browser_fragment.py`, `scripts/tests/test_browser_runtime.py`, `docs/manual/browser.md`, `docs/VERIFICATION.md`, `backlog.md`; dependencies: METIS-BROWSER-001, METIS-COMMANDS-001, METIS-AUTHORITY-001; risk: remote markup and stale lifecycle
