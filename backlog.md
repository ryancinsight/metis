...
- Status: in-progress; priority: P1; owner: Metis Windows host + Moirai; integrator: root; last-update: 2026-09-22; ADR: [0032](docs/adr/0032-display-scale.md); dependencies: METIS-AUTHORITY-001, METIS-COMMANDS-001; risk: trust boundary
...
- Current increment (2026-09-20): the release caller pins current Atlas merge `227ff172612b8aff553be22be89fabdf71838a03`, which owns the shared `cp314t`/`cp315t` and Python 3.15 `abi3t` matrix, compressed macOS universal2 tag validation and portable source-distribution metadata extraction; the default remains CPython 3.9 `abi3`. Confirming run `35507532874` on Metis merge `4b194f5e1bd914f61390688104d50dbb81f38c05` passed all 18 concrete wheel jobs and `Validate distributions` against the preceding Atlas workflow revision; the empty CPython matrix placeholder and PyPI publish job were skipped. The retained `verification-wheels` artifact has 19 files (18 wheels plus source distribution), 6,842,856 bytes and digest `sha256:c85905c00574f2d052e2dd270486b91174f532d0373f352bf5982fa7062e3d33`; provider value tests passed and no publication occurred. The caller and package remain tokenless OIDC, and musllinux stays outside `abi3t` until a compatible 3.15t image exists.
...
- Status: in-progress; priority: P1; owner: Metis input/presentation; integrator: root; last-update: 2026-09-22; dependencies: METIS-INPUT-001; risk: text corruption
...
- Status: in-progress; priority: P1; owner: Metis asset/presentation + existing Atlas format providers; integrator: root; last-update: 2026-09-21; dependencies: METIS-BROWSER-001, METIS-AUTHORITY-001; risk: hostile content
...
- Historical replay reconciliation (superseded by RITK PR #594): RITK PR #588 merge `27ac7d12bc69a04f7fb12e5ba41ef8fd4fe93aa9` remains preserved with its exact provenance; the current comparison basis is the delivery below.
...
- Documentation increment (2026-09-22): the application and browser manuals now bind their current standalone replay claims to RITK PR #594 merge `67d4ad4457823f928b02739ec120bc0329a1b7f0`, replay source `c842689b985beecb159bba17cc1b3a6a50e67c6a`, Metis `776dbbf94593e42d0a5686b587ed27b72f885a73`, Moirai `0e2e1bbb2d81e16dd9c694ba46a9e9710e034417`, lock SHA `602cba1b0a1a2b6ce8bdb61f42d9c3ef2844bdfd76e5120a29b5a6d8c46552ec` and executable SHA `14412a80c37a19a2f4a09cb08165831a2311d4476f24d1ee159b34406eaf9b30`; hosted browser evidence is run `35724926751` and the 2026-09-20 resource sample remains historical.
