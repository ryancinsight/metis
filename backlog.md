...
- Status: in-progress; priority: P1; owner: Metis frontend/host; integrator: root; last-update: 2026-09-12; branch: `feat/browser-file-selection-metis-browser-001`; regions: `crates/metis-web/src/controls.rs`, `crates/metis-web/src/browser/file_drop.rs`, `examples/browser/gallery.html`, `docs/adr/0008-browser-host-boundary.md`, `docs/manual/browser.md`, `docs/VERIFICATION.md`; dependencies: METIS-STATE-001, METIS-ASYNC-001, METIS-AUTHORITY-001; risk: browser/native trust boundary
