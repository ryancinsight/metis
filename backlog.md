...
- Completed increment (2026-09-13, branch `feat/browser-lifecycle-evidence-001`): a live Microsoft Edge 154.0.4258.12 run with msedgedriver 153.0.4234.19 completed four bounded stop/remount cycles at Metis `790550a2a0f34bdd23ad1b4afdf6a6552baa9e55`. Stopped generations 3, 5, 7 and 9 reported zero controls/listeners; remounted generations 4, 6, 8 and 10 reported 27 controls/31 listeners. The sanitized trace and five inspected PNGs are in [`docs/manual/images`](docs/manual/images/metis-browser-edge-lifecycle.json); provider-private resources and non-Chromium engines remain open.
