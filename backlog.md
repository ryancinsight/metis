...
- Lease: root `scripts/python_native_capture.py`, `scripts/tests/test_python_native_capture.py`, `docs/manual/native.md`, `docs/VERIFICATION.md`, `docs/adr/0032-display-scale.md`, `docs/adr/README.md` — bounded physical-monitor DPI probe and evidence.
