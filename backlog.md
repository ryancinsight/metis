...
- Residuals: the eframe and native Métis runs now match the public input and panel semantics, but surface dimensions and process boundaries remain different; GPUI/Tauri fixtures, WASM committed/used memory, allocation and frame-latency traces, repeated lifecycle growth and controlled-host uncertainty remain open.
