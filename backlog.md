...
- Completed increment (2026-09-18): commit `c28b1b7` adds the bounded same-origin WOFF2 fixture and `--font-load-probe`; Edge 154.0.4258.12 at device scale 1.25 records loaded/application/rejection/teardown for three lifecycle observations. The trace is bound to revision `c28b1b7f40eec3d76b8d89c2c31aa010dae092f7` and SHA-256 `8e0a559475115aeb36a0b9ea32fff795b6a451fa20a4ed1a0d7b54c335e70948`; the loaded face measures 308 px against a 158 px fallback, `FontFaceSet.check` is true, and each face is released.
