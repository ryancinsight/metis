...
- Current increment: the format-neutral canvas runner can focus each canvas and record a trusted `ArrowDown` keydown/keyup pair with bounded key, code, repeat and modifier metadata; the local dependency-free suite passes 47/47. Hosted RITK validation remains pending.
