...
- Current replay reconciliation (2026-09-19): the standalone-lock real-MRI replay binds RITK `9ea19856c63dbe5b956c81560bad044a48705ee1`, Metis `b432446f5dbc39fb328220f45ba0d0341eb03263`, Moirai `5075d4c70ba4f840d4c5a47b67c5d564405badf5` and Cargo.lock SHA-256 `182203ea9a9d13dbd596753055b96777954d68173228cfe22475cf496d58ac32`; the 94-file, 49,807,236-byte study produced the byte-identical 1280 × 800 frame with 411,589 non-black pixels, executable SHA-256 `a848580e42105e8a6798bbfb1a8fb0574fc3bc7d0dd7e8df31e337f3006526c9`, and invalid-study exit 1. The exact provenance is recorded in [RITK's replay record](../ritk/docs/manual/images/dicom-metis-real-mri.json). This closes the current lock/evidence prerequisite; matched GPUI/Tauri fixtures, allocator/compositor measurements and controlled-host ranking remain open.
...
- Current replay reconciliation (2026-09-19): the standalone lock binds RITK source `9ea19856c63dbe5b956c81560bad044a48705ee1`, Metis `b432446f5dbc39fb328220f45ba0d0341eb03263`, Moirai `5075d4c70ba4f840d4c5a47b67c5d564405badf5` and Cargo.lock SHA-256 `182203ea9a9d13dbd596753055b96777954d68173228cfe22475cf496d58ac32`. The 94-file, 49,807,236-byte replay remains the 1280 × 800, 411,589 non-black-pixel MRI frame with capture SHA-256 `259dd79103482756c4e688621bebafc841cc40f1df10ff2bbd7f9d04b7b4d401` and executable SHA-256 `a848580e42105e8a6798bbfb1a8fb0574fc3bc7d0dd7e8df31e337f3006526c9`; the invalid-study probe exits 1. [RITK's replay provenance](../ritk/docs/manual/images/dicom-metis-real-mri.json) is authoritative; matched GPUI/Tauri, WASM used-memory/allocation, compositor/native latency and controlled-host ranking residuals remain open.
- Recorded resource baseline (2026-09-18): `scripts/resource.py` ran three bounded lifecycle samples against the standalone-lock RITK/Métis executable and 94-file public MRI-DIR study. Peak private bytes averaged 719,981,227 ± 3,928,545; peak working set averaged 313,288,021 ± 1,495,454; lifecycle duration averaged 1,955 ± 956 ms; all exits and capture hashes passed. The record binds Metis `0ca361cd0540c773822b78477530bc17d3863461`, RITK `e635baf90f99cc0ae09df06c42424ba5c4c6faec`, Moirai `a2f21496d1d09b2abe6523e3c8cdbf751dcd560a` and command fingerprint `4133bd95b160b14d0a8adf090a3434b43d80bf47f9ac37253d90fe53362d3ec1`; it is a historical process measurement rather than a claim about the latest source tree. Matched GPUI/Tauri/egui, WASM allocator, compositor and ranking residuals remain open.
...
- Current replay reconciliation (2026-09-19): the standalone-lock replay uses RITK source `9ea19856c63dbe5b956c81560bad044a48705ee1`, with Metis `b432446f5dbc39fb328220f45ba0d0341eb03263`, Moirai `5075d4c70ba4f840d4c5a47b67c5d564405badf5` and standalone Cargo.lock SHA-256 `182203ea9a9d13dbd596753055b96777954d68173228cfe22475cf496d58ac32`. It reads all 94 saved MRI-DIR files (49,807,236 bytes), reproduces the committed 1280 × 800 MRI frame with SHA-256 `259dd79103482756c4e688621bebafc841cc40f1df10ff2bbd7f9d04b7b4d401` and 411,589 non-black pixels, and rejects the invalid-study probe. The [RITK provenance record](../ritk/docs/manual/images/dicom-metis-real-mri.json) is the visual oracle; RITK owns DICOM decoding and clinical presentation, while Metis remains the format-neutral host. Safari selected-file authorization and hosted Chromium WebGPU adapter availability remain open host residuals.
- Current lock correction (2026-09-19): the authoritative standalone consumer replay is the RITK lock change `fdbbd7394cc3f7cac746f2bad64608edad8d015f`, merged as `e4eb95b5769e51066533c52ac32fc70306a9224e`, with Metis `d7cb62f5139d2e4e30a476d71b81e480c04e0226`, Moirai `b179b89fd2521034d2fc9c97663649811982e9fa` and Cargo.lock SHA-256 `2194947dad2fd91be235b6e7546b7ca506f62ba00f0a33ba30dcf628197f53c1`. The locked native replay remains 450/450 with the 94-file, 49,807,236-byte study, byte-identical 1280 × 800 frame (`259dd791...`, 411,589 non-black pixels) and invalid-study exit 1; the older hashes above are historical evidence, not the current comparison basis. The next conformance slices are OS capability enforcement, native accessibility/IME evidence, matched GPUI/Tauri fixtures, and explicit WebGPU recovery; Safari selected-file authorization remains an external host blocker.
