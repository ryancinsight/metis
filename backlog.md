...
- Provider delivery: Moirai #386/#387/#388 deliver generation cleanup, terminal error propagation and the matching source-contract repair. [Moirai #390](https://github.com/ryancinsight/Moirai/pull/390) queues the owning socket-lifetime correction at `a0f4fd296fe6ade8fd0d99d0045cafc85cfe400b`; all eleven consumer pins now select that immutable revision with no other lockfile changes. Its reviewed Windows gate passes 1,129 workspace tests (ten skips), 99 all-feature PAL release tests (one skip), 26 doctests (one ignored), warning-clean Clippy/Rustdoc and 196 SemVer checks. Exact records: `output/moirai-socket-final/`.
