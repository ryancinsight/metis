...
- Completed increment (2026-09-12, Metis `8c105e1`, Moirai `3caa6c24`, RITK consumer `52f5c52fbe3b8df18f275159ba7d79bd2a57c9c0`): the user-activated `#file-input` chooser now feeds Moirai's bounded browser file handles through the same 512-file, 64 MiB/file and 256 MiB/batch reader as drag/drop. The in-app Chromium run selected the 409 real public CT files, read 216,156,416 bytes and presented ready non-black axial, coronal and sagittal canvases; [the exact DOM and build evidence](docs/VERIFICATION.md#browser-file-selection-evidence--2026-09-12) records the attributes and revisions.
