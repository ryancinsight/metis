...
- Documentation increment (2026-09-14): the README links the committed native capture manifest and identifies the visible Windows native/WebView2 journeys as current evidence; remaining host-specific display-scale, accessibility, IME, permission and non-Windows requirements stay open.
