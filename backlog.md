...
- Status: in-progress; priority: P1; owner: Metis frontend/host; integrator: root; last-update: 2026-09-16; branch: `feat/metis-browser-page-query`; regions: scripts/browser_drop.py, scripts/tests/test_browser_drop.py, docs/manual/browser.md, docs/VERIFICATION.md, backlog.md; dependencies: METIS-STATE-001, METIS-ASYNC-001, METIS-AUTHORITY-001; risk: browser/native trust boundary
- lease: root scripts/browser_drop.py, scripts/browser_canvas_capture.py, scripts/tests/test_browser_drop.py, docs/manual/browser.md, docs/VERIFICATION.md, backlog.md (2026-09-16T16:05:00-04:00)
