...
- Status: in-progress; priority: P1; owner: Metis protocol/browser; integrator: root; last-update: 2026-09-10; branch: `fix/metis-gate-tools`; dependencies: METIS-BROWSER-001, METIS-COMMANDS-001, METIS-AUTHORITY-001; risk: remote markup and stale lifecycle
...
- Claim: root; scope: rescue the unique checksum-verified release-binary gate-tool workflow fix from the stale `feat/framework-slices-001` branch; no browser or DICOM behavior changes.
