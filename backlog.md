...
- Current increment (2026-09-13): the canvas trace derives element-local pointer and wheel offsets from each canvas's CSS dimensions, keeping trusted actions within short coronal and sagittal surfaces. The prior fixed wheel point was outside those canvases and produced no wheel event; a live Edge MRI replay is the acceptance evidence.
