...
- Current evidence reconciliation (2026-09-16): Metis's standalone lock, README and current testing/native verification text now agree on Moirai merge `21b66ba424ad8f50d8574d6e9714be696f807e82`, including the extent guard, content-box mapping and explicit WebGPU canvas provider. The risk register records the hosted RITK run [35089121864](https://github.com/ryancinsight/ritk/actions/runs/35089121864): Chromium and Firefox pass the real 94-file MRI study, while Safari's selected-file read remains an external WebKit authorization failure. The DICOM ownership row makes RITK's scanner/decoder/presentation boundary explicit and removes the obsolete pre-publication source-pin risk; real GPU output and recovery remain open consumer evidence.
