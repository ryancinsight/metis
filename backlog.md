...
- Residuals: native image decode and clinical orientation metadata, font loading, video playback/native media providers, GPU vectors, and runtime shell rendering on a Windows install remain open under V06; browser local-mark decode, audio playback, media error/teardown, SVG admission, ICO packaging and format-neutral pixel-grid orientation contracts are closed.
