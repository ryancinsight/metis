...
- lease: root scripts/browser_media.py, scripts/tests/test_browser_media.py, scripts/browser_runtime.py, scripts/browser_runtime_cli.py, examples/browser/assets/metis-tone.wav, metis.json, docs/manual/browser.md, docs/VERIFICATION.md 2026-09-18T05:00:00-04:00
...
- Residuals: native image decode and clinical orientation metadata, font loading, media playback controls, GPU vectors, and runtime shell rendering on a Windows install remain open under V06; browser local-mark decode, media error/teardown, SVG admission, ICO packaging and format-neutral pixel-grid orientation contracts are closed.
