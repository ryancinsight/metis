...
- Completed increment (2026-09-22): the native Unicode capture runner exercised the production Windows host with combining-mark, emoji and mixed-direction fixtures. Moirai's surrogate-preservation correction is committed at `0c2f752e28c6683d91440783a8b5967a78fa909d` and is pushed in open PR [#435](https://github.com/ryancinsight/Moirai/pull/435); the PR is not counted as merged.
...
- Historical replay reconciliation (superseded by RITK PR #592): RITK PR #588 merge `27ac7d12bc69a04f7fb12e5ba41ef8fd4fe93aa9` and standalone replay source `b671ae72a20bb6d113de35314e73874f197d2a83` remain preserved with their Metis, Moirai, lock and executable hashes in git history. The 94-file MRI frame and invalid-study result are unchanged; the current comparison basis is the delivery below.
...
- Historical replay reconciliation (superseded by RITK PR #592): RITK PR #588 merge `27ac7d12bc69a04f7fb12e5ba41ef8fd4fe93aa9` remains preserved with its exact provenance; the current comparison basis is the delivery below.
...
- Documentation increment (2026-09-22): the application and browser manuals now bind their current standalone replay claims to RITK PR #592 merge `620c03342f3951366441f1f908d05bc3f249f566`, replay source `36b8330d3dfa450ae81523fc1ebc6e59413a1dc4`, Metis `219143bbf3596aea85fa4624d7d5241a63b4cf0d`, Moirai `0e2e1bbb2d81e16dd9c694ba46a9e9710e034417`, lock SHA `acb5bd6c7c82ced80c052ae542dcd63992badf8d00a982c986f64716f5736b10` and executable SHA `f416deadbb8a17ab4ffa1d58e1eef007bd1887883ad638fbbf82fa038ec063f9`; the 2026-09-20 resource sample remains historical.
...
- Documentation increment (2026-09-22): current manual and ADR replay claims now bind merged RITK PR #592 standalone lock to Metis `219143bbf3596aea85fa4624d7d5241a63b4cf0d`, Moirai `0e2e1bbb2d81e16dd9c694ba46a9e9710e034417`, Cargo.lock `acb5bd6c7c82ced80c052ae542dcd63992badf8d00a982c986f64716f5736b10` and executable `f416deadbb8a17ab4ffa1d58e1eef007bd1887883ad638fbbf82fa038ec063f9`; remaining target, accessibility, matched-comparison and WebGPU residuals stay open under their linked items.
...
- Superseded lock correction (RITK PR #588): its exact lock and replay remain historical evidence; the current lock correction is the RITK PR #592 delivery immediately below. The next conformance slices are OS capability enforcement, native accessibility/IME evidence, matched GPUI/Tauri fixtures, and explicit WebGPU recovery; Safari selected-file authorization remains an external host blocker.
