...
- Status: in-progress; priority: P1; owner: Metis framework + application owners; integrator: root; last-update: 2026-09-13; branch: `docs/real-image-gallery-001`; regions: `docs/manual/README.md`, `backlog.md`; risk: lost application behavior.
