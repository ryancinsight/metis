...
- Status: in-progress; priority: P1; owner: Metis frontend/host; integrator: root; last-update: 2026-09-15; branch: `build/metis-moirai-safari-lock`; regions: Cargo.lock, README.md, backlog.md; dependencies: METIS-STATE-001, METIS-ASYNC-001, METIS-AUTHORITY-001; risk: browser/native trust boundary
...
- Status: in-progress; priority: P1; owner: Metis UI/host; integrator: root; last-update: 2026-09-15; branch: `feat/metis-native-key-modifiers`; regions: `crates/metis-python/src/native/events.rs`, `crates/metis-python/tests`, `docs/manual/python.md`, `docs/adr/0026-python-native-host.md`, `backlog.md`; dependencies: METIS-BROWSER-001, MOI-WINDOW-KEY-MODIFIERS-2026-09-15; risk: native shortcut modifier state loss; ADR: 0014, 0027
...
- Completed increment (2026-09-15): Metis PR consumes Moirai PR [#345](https://github.com/ryancinsight/Moirai/pull/345), merge `8d032e38bc30a754c2d909325a0d27a1c2ab45cb`; the Python native event dictionaries now preserve `ctrl`, `shift`, `alt` and `meta` snapshots on keydown/keyup alongside key and repeat values. The locked Metis package gate and strict Clippy pass against the updated provider.
