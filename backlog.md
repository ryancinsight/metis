...
- Status: review; priority: P1; owner: Metis Windows host + Moirai; integrator: root; last-update: 2026-09-17; branch: `feat/metis-webview2-permission-event`; regions: `crates/metis-platform/src/native/mod.rs`, `crates/metis-platform/src/native/webview.rs`, `crates/metis-app/src/frontend/webview.rs`, `crates/metis-app/src/frontend/webview/tests.rs`, `crates/metis-core/src/error.rs`, `crates/metis-core/tests/host.rs`, `Cargo.lock`, `README.md`, `docs/manual/native.md`, `docs/VERIFICATION.md`, `docs/adr/0015-native-window-provider.md`, `backlog.md`; ADR: [0032](docs/adr/0032-display-scale.md); dependencies: METIS-AUTHORITY-001, METIS-COMMANDS-001; risk: trust boundary
