...
- Status: in-progress; priority: P1; owner: Metis frontend/host; integrator: root; last-update: 2026-09-15; branch: `feat/metis-browser-keyboard-profiles`; regions: scripts/browser_canvas.py, scripts/browser_runtime.py, scripts/browser_drop.py, scripts/tests/test_browser_runtime.py, backlog.md; lease: root scripts/browser_canvas.py, scripts/browser_runtime.py, scripts/browser_drop.py, scripts/tests/test_browser_runtime.py 2026-09-15T18:30:00-04:00; dependencies: METIS-STATE-001, METIS-ASYNC-001, METIS-AUTHORITY-001; risk: browser/native trust boundary
