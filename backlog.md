...
- Evidence: focused geometry/runtime checks pass 69/69. A local Microsoft Edge trace at source revision `0222f60214305ea3d3a82aac0bb38c10f622cf1d` is `status: passed`; it records `16px system-ui, sans-serif`, `loaded`, `true` and widths `18/10/32/37/22` in `output/browser/runtime/edge-text-font-20260918.json` (SHA-256 `8ac598eeb9c15b645197f866199f6aebcb0a44f4086fccbda2ac7105c6ecc6d6`). This measures host font behavior without identifying fallback-face selection or claiming native/cross-engine parity.
