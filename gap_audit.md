...
| Comparative claims lack matched evidence | Real three-run eframe and native Métis lifecycle samples now bind public CT/MRI captures, but surfaces and process boundaries differ; no matched GPUI/Tauri, input-to-frame, allocator-used or security comparison exists | [PERF](backlog.md#METIS-PERF-001), [QUALITY](backlog.md#METIS-QUALITY-001): match fixtures and add the remaining host, allocation and denial probes. |
