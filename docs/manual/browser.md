...
runner bounds the returned tree, checks that the visible `main`, `form`, `button`, `textbox`
...
excluding deep text descendants. It does not claim spoken screen-reader output
or an operating-system accessibility bridge.
