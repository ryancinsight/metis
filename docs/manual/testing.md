...
compares the current nine form captures, including light and dark anchored
command menus, and their recorded inputs, actions, labels and geometry with the
...
Add `--text-geometry-probe` to the workbench command to append
