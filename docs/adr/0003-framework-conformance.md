...
| Routing | Typed `Routable` enum router with nested layouts and history [D5] | Metis has deep-link parsing but no client-side router. A typed route table that reuses `DeepLink` segments is open. [MIGRATION](../../backlog.md#METIS-MIGRATION-001) |
