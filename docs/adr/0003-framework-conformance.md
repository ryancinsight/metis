...
| Large lists, tables and reactive updates | Extras tables [E6] | Elements support large list views [G1] | Frontend framework/browser concern | No virtualized controls or reusable subscriptions. DATA (`METIS-DATA-001`), STATE (`METIS-STATE-001`). |
