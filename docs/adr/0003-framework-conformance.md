...
Metis now captures validated `DropFiles`, reads the first selected DICOM header
through the provider-owned browser `File` handle and reports the Part 10 marker.
