...
and retains the existing one-pixel segment primitive. GPU vectors, arbitrary
affine transforms, browser vector parity and device-loss recovery remain open.
