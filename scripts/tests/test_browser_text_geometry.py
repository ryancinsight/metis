...
class BrowserTextGeometryTests(unittest.TestCase):
    def test_script_uses_segmented_ranges_and_removes_probe(self):
        ...
        self.assertIn("renderedFragments", TEXT_GEOMETRY_SCRIPT)
        self.assertIn("geometryFragments", TEXT_GEOMETRY_SCRIPT)
        self.assertIn("lineCoordinate", TEXT_GEOMETRY_SCRIPT)
