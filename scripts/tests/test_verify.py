...
class WorkflowContractTests(unittest.TestCase):
    ...
    def test_browser_runtime_runs_authenticated_fragment_matrix(self):
        for fragment in (
            ...
            "scripts/browser_static_server.py",
            "--directory output/browser",
            "--port-file \"$static_port_file\"",
            "--scenario fragment",
            "--url \"$origin/http-health.html\"",
            "target/debug/metis-app",
            "--metis-http-service \"$origin\" 8766",
...
class PythonBindingContractTests(unittest.TestCase):
    ...
    def test_release_caller_is_tokenless_and_uses_atlas_wheels(self):
        for fragment in (
            ...
            "id-token: write",
            "ryancinsight/atlas/.github/workflows/python-wheels.yml@628dee69887e73948f74336806313511b2aa4df9",
