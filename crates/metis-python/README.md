...
The dictionaries include `accessibility_action` records with the stable target
node, action name, optional replacement value and optional signed adjustment.
