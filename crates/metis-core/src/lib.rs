...
pub use protocol::{
    ...
    PROTOCOL_MAGIC, PROTOCOL_VERSION, Plugin, PluginDescriptor, PluginInvocationPayload,
    PluginInvocationResponsePayload, PluginOperation, PluginRegistry, RemoteEventPayload,
    SUPPORTED_COMMANDS, build_frame,
};
