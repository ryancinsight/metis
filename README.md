...
`d7b38d7c79dfd39096adeda0f5c0845064d7a8c6`, which includes the Windows
AccessKit accessibility provider, the UI Automation value-action mapping and
WebView2 0.39.1 bindings. The current
