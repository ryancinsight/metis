...
## root
- [Commands and events](backlog.md#METIS-COMMANDS-001): capability catalog, explicit unsupported-operation response, and bounded subscription primitive are the current leased slice; ADR 0012 is claimed.
