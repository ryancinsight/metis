...
- [Interactive controls](backlog.md#METIS-INPUT-001): claim the Moirai checked-state DOM seam, add Rust-owned checkbox/radio/range state, and update the browser manual with an observed keyboard/pointer journey.
