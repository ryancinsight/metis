...
## root
- [Browser lifecycle](backlog.md#METIS-ASYNC-001): published-source audit collected; claim the Moirai browser scope, revise its ADR 0007 around local ownership/cancel/deadlines, implement and run real-browser conformance, then migrate the Metis client.
