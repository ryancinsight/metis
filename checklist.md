...
## root
- [Commands and events](backlog.md#METIS-COMMANDS-001): capability catalog, explicit unsupported-operation response, bounded subscription primitive, and versioned remote event transport pass 93 focused tests, the full gate, and the live browser trace; typed plugin manifest registration is the active increment, while native unsolicited-event tracing remains.
