...
## root
- [Commands and events](backlog.md#METIS-COMMANDS-001): capability catalog, explicit unsupported-operation response, and bounded subscription primitive pass 84 focused tests, the full gate, and the live browser trace; remote event serialization and typed registration remain.
