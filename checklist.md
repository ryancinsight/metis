...
## root
- [Commands and events](backlog.md#METIS-COMMANDS-001): capability catalog, explicit unsupported-operation response, bounded subscription primitive, versioned remote event transport and typed plugin manifest registration are implemented; native unsolicited-event tracing and remote plugin invocation remain.
