...
## root
- [Browser lifecycle](backlog.md#METIS-ASYNC-001): Moirai owns browser callbacks and deadlines; Metis has the bounded async client/WebSocket seam and one-pump out-of-order correlation. Run real-browser conformance and teardown evidence before closing the item.
