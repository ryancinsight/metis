...
## root
- [Presentation styles](backlog.md#METIS-UI-001): strict `ComputedStyle::parse` diagnostics, parser propagation, migration guide and V04 evidence synchronized; focused gates pass before the independent review panel.
