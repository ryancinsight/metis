...
- [Provider](backlog.md#METIS-PROVIDER-001): audit Moirai and Iris source revisions, standalone lock coherence, Atlas-only direct edges and contract tests against the merged provider.
